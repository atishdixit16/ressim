...
from test_cases_2ph import test_case_scipy, test_case_implicit, test_case_explicit
...
fig.savefig('solution_compare_2ph.png', bbox_inches=0, pad_inches=0)
...
plt.ylim([0.0,0.2])
plt.savefig('time_comparison_2ph.png',  bbox_inches=0, pad_inches=0)
